 ...
 */
package io.gravitee.alerter.ws.spring;
...
public class PropertiesConfiguration {
    ...
    public static Properties graviteeProperties() throws IOException {
        LOGGER.info("Loading Gravitee Alerter configuration.");
        ...
        LOGGER.info("\tGravitee Alerter configuration loaded from {}", yamlResource.getURL().getPath());

        yaml.setResources(yamlResource);
        Properties properties = yaml.getObject();
        LOGGER.info("Loading Gravitee Alerter configuration. DONE");
